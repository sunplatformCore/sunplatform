/* src/config/sunplatform-config.h.  Generated from sunplatform-config.h.in by configure.  */
/* src/config/sunplatform-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.sunplatform.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Sunplatform Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Sunplatform Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sunplatform"
