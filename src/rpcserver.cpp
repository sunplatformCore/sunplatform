...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Sunplatform server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Sunplatform server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Sunplatform features */
        {"sunplatform", "masternode", &masternode, true, true, false},
        {"sunplatform", "listmasternodes", &listmasternodes, true, true, false},
        {"sunplatform", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sunplatform", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sunplatform", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sunplatform", "masternodedebug", &masternodedebug, true, true, false},
        {"sunplatform", "startmasternode", &startmasternode, true, true, false},
        {"sunplatform", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sunplatform", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sunplatform", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sunplatform", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sunplatform", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sunplatform", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sunplatform", "mnbudget", &mnbudget, true, true, false},
        {"sunplatform", "preparebudget", &preparebudget, true, true, false},
        {"sunplatform", "submitbudget", &submitbudget, true, true, false},
        {"sunplatform", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sunplatform", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sunplatform", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sunplatform", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sunplatform", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sunplatform", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sunplatform", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sunplatform", "checkbudgets", &checkbudgets, true, true, false},
        {"sunplatform", "mnsync", &mnsync, true, true, false},
        {"sunplatform", "spork", &spork, true, true, false},
        {"sunplatform", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"sunplatform", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sunplatformd, or the -server option to sunplatform-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> sunplatform-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:62891/\n";
}
