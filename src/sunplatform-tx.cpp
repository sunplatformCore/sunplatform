...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sunplatform Core sunplatform-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sunplatform-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sunplatform transaction") + "\n" +
                               "  sunplatform-tx [options] -create [commands]   " + _("Create hex-encoded sunplatform transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sunplatform transaction
