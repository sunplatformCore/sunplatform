...
/** Utility functions used by the Sunplatform Qt UI.
 */
namespace GUIUtil
{
...
// Render Sunplatform addresses in monospace font
...
// Parse "sunplatform:" URI into recipient object, return true on successful parsing
