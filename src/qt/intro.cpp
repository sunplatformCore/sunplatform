...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Sunplatform Core"),
     ...
     * override -datadir in the sunplatform.conf file in the default data directory
     * (to be consistent with sunplatformd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
