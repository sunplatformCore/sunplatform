                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Sunplatform Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sunplatform address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sunplatform: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Sunplatform Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sunplatform Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sunplatform"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sunplatform addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sunplatform addresses"));
    ...
    openAction->setStatusTip(tr("Open a Sunplatform: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sunplatform Core help message to get a list with possible Sunplatform command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Sunplatform Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sunplatform network", "", count));
}
...
{
    QString strTitle = tr("Sunplatform Core"); // default title
