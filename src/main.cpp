...
#if defined(NDEBUG)
#error "Sunplatform cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight < 50 && nHeight > 0) { //Premine phase 400,000 coins in this phase 8k coins each block for 50 blocks
		nSubsidy = 8000 * COIN;
	}
	else if (nHeight < 200 && nHeight > 50) { //PoW 1 reward
		nSubsidy = 1 * COIN;
	}
...
{
    RenameThread("sunplatform-scriptch");
