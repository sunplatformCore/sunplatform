...
In order to support loading of multiple wallets in sunplatform-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sunplatform.cpp.
...
Changes to sunplatform.cpp
----------------------
sunplatform.cpp is the entry point into sunplatform-qt, and as such, will require some minor modifications to provide hooks for
